...
file_list_depth = glob.glob(f'{directory_path}/m1455541/ibims1_core_raw/depth/*', recursive=True)
...
# Use the glob.glob() function to find files that match the fixed pattern.
file_list_png = glob.glob(f'{directory_path}/m1455541/ibims1_core_raw/rgb/*', recursive=True)
