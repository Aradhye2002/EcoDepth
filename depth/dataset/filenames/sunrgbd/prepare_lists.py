...
file_list_depth = glob.glob(f'{directory_path}/downloaded/SUNRGBD/*/*/*/depth/*', recursive=True)
...
# Use the glob.glob() function to find files that match the fixed pattern.
file_list_png = glob.glob(f'{directory_path}/downloaded/SUNRGBD/*/*/*/image/*', recursive=True)
